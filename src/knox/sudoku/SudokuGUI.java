...
public class SudokuGUI extends JFrame {
    ...
    private void createMenuBar() {
        ...
        //that will override the inherited actionPreformed() method
        ...
        JMenu type = new JMenu("Game Type");
        menuBar.add(type);
        
        addToMenu(type, "Easy", new ActionListener() {
        	@Override
			public void actionPerformed(ActionEvent e) {
        		sudoku.load("easy1.txt");
        ...
        addToMenu(type, "Medium", new ActionListener() {
        	@Override
			public void actionPerformed(ActionEvent e) {
        		sudoku.load("medium1");
        ...
        addToMenu(type, "Hard", new ActionListener() {
        	@Override
			public void actionPerformed(ActionEvent e) {
        		sudoku.load("Hard1");
        ...
        addToMenu(type, "Expert", new ActionListener() {
        	@Override
			public void actionPerformed(ActionEvent e) {
        		sudoku.load("expert1");
        ...
        JMenu solution = new JMenu("Solutions");
        menuBar.add(solution);
        
        addToMenu(solution, "Easy", new ActionListener() {
        	@Override
			public void actionPerformed(ActionEvent e) {
        		sudoku.load("easyS");
        ...
        addToMenu(solution, "Medium", new ActionListener() {
        	@Override
			public void actionPerformed(ActionEvent e) {
        		sudoku.load("mediumS");
        ...
        addToMenu(solution, "Hard", new ActionListener() {
        	@Override
			public void actionPerformed(ActionEvent e) {
        		sudoku.load("hardS");
        ...
        addToMenu(solution, "Expert", new ActionListener() {
        	@Override
			public void actionPerformed(ActionEvent e) {
        		sudoku.load("expertS");
